package ContasSpring.ExContasSpring.resource;
...
import ContasSpring.ExContasSpring.service.*;
import ContasSpring.ExContasSpring.model.*;
...
public class ContaResource {
	...
	@PutMapping("/{numero}")
	public ResponseEntity<?> update(@PathVariable("numero") Integer numero, @RequestBody Conta conta) {
